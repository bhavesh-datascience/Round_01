...
export default function HomePage() {
  ...
  }, [state.teamName, state.startTime, router])
      ...
      <section className="mx-auto max-w-3xl px-4 py-12">
        <Card className="relative mx-auto w-full rounded-2xl bg-card/60 backdrop-blur-md ring-1 ring-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.45)]">
          <CardHeader className="text-center">
            {/* badge */}
            <div className="mx-auto mb-3 grid h-12 w-12 place-items-center rounded-full bg-yellow-600/80 ring-1 ring-yellow-500/60 shadow-[0_0_20px_rgba(255,184,0,0.35)]">
